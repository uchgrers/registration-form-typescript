...
export default async function handler(req, res) {
    ...
    if (url.startsWith("/registrationFormApi/auth") && method === "POST") {
        return handleAuth(req, res);
    }

    if (url.startsWith("/registrationFormApi/logout") && method === "POST") {
        return handleLogout(req, res);
    }

    if (url.startsWith("/registrationFormApi/users") && method === "GET") {
